...
public class CLIInterface {
    ...
    private static void printMap(Simulator sim){
        ...
        System.out.println();
        System.out.println(c(BOLD, "  City map   tick " + sim.currentTickView.get() + "   " + city.name + "   $" + (int)(double)city.moneyView.get()));
        System.out.println();
                    ...
                    if (b == null) {
                        ...
                        if (!b.getVisitors().isEmpty()) {
                            ...
                            for (com.project.city.Citizen citizen : b.getVisitors()) {
                                ...
                                citizen.getDetailedInfo().forEach((k, v) ->
        ...
        while (true) {
            ...
            switch (cmd) {
                ...
                case "new" -> {
                    ...
                    if (name.isEmpty()) name = "My New Town";
                    if (name.contains("/")) {
                    ...
                    int size = 10;
                    try { size = Math.max(10, Math.min(20, Integer.parseInt(sc.nextLine().trim()))); }
                    ...
                    int di = 0;
                    try { di = Math.max(0, Math.min(diffs.length - 1, Integer.parseInt(sc.nextLine().trim()))); }
                    catch (NumberFormatException ignored) {}
